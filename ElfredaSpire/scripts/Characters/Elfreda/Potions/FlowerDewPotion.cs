...
public class FlowerDewPotion : ModPotionTemplate
{
    ...
    protected override async Task OnUse(PlayerChoiceContext choiceContext, Creature? target)
    {
        ...
        await PowerCmd.Apply<FlowerElfredaPower>(choiceContext, target, DynamicVars["FlowerElfredaPower"].IntValue, Owner.Creature, null);
    }
}
