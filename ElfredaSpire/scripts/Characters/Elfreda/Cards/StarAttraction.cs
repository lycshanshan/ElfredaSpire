...
public class StarAttraction : ModCardTemplate
{
    public StarAttraction() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self, true)
    {
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<StarElfredaPower>(2), new CardsVar(1)];
