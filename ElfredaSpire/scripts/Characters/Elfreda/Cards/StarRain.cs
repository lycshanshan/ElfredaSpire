...
public class StarRain : ModCardTemplate
{
    public StarRain() : base(1, CardType.Attack, CardRarity.Common, TargetType.AllEnemies, true)
    {
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(6, ValueProp.Move), new PowerVar<StarElfredaPower>(2)];
