// | 星之壁 | StarWall | 技能 | 1 | 获得5点格挡。每有1层[星]，额外获得2/3点格挡。 |
...
{
    public StarWall() : base(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self, true)
    {
    }
    ...
    [
        ...
        ModCardVars.ComputedBlock("BlockValue", 5, card =>
