...
{
    public SimulatedOffering() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.Self, true)
    {
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<StarElfredaPower>(6)];
